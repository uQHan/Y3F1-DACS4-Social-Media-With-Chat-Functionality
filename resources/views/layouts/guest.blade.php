...
<body class="w-full font-sans text-gray-900 antialiased bg-gray-100 dark:bg-gray-900">
    <header class="grid grid-cols-2 items-center py-2 lg:grid-cols-3">
        <div class="flex lg:justify-center lg:col-start-2">
        </div>
        @if (Route::has('login'))
        <nav class="-ml-3 flex flex-1 justify-end">
            @auth
